...
?>
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="./admin/assets/images/products/<?php echo $row['image']; ?>" alt="Image">
                        </div>
    ...
    <div class="h-100 bg-light p-30">
        ...
        <h3 class="font-weight-semi-bold mb-4"><?php echo $row['price'].' LKR'; ?></h3>
        ...
        <script>
            ...
            function updateAmountInURL() {
                var amount = document.getElementById('amountInput').value;
                var addToCartBtn = document.getElementById('addToCartBtn');
                var href = "add_to_cart.php?id=<?php echo $row['id']; ?>&amount=" + amount;
