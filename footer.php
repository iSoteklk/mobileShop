  ...
  <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-4"></p>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Street, Kurunegala, Sri Lnka</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>info@ft.lk</p>
                <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>+94 377 265789</p>
            </div>
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-secondary">
                    &copy; <a class="text-primary" href="#">FutureTech</a>. All Rights Reserved. Designed
                    by
                    <a class="text-primary" href="#">FutureTech.lk</a>
                </p>
            </div>
